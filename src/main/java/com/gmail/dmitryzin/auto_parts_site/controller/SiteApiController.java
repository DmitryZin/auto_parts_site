...
public class SiteApiController {
    ...
    @GetMapping("/v1/parts/byNumber/{number}")
    ...
    @GetMapping("/v1/parts/forAuto/brand/{brand_id}")
    ...
    @GetMapping("/v1/parts/forAuto/model/{model_id}")
    ...
    @GetMapping("/v1/parts/forAuto/car/{car_id}")
    ...
    @GetMapping("/v1/parts/forAuto/engine/{engine_id}")
    ...
    @GetMapping("/v1/parts/part/{part_id}")
